...
public class MaterialTabLayout extends HorizontalScrollView {
     ...
     * <li>Set our {@link MaterialTabLayout.OnTabSelectedListener} which will forward
    ...
    /**
     * A {@link MaterialTabLayout.OnTabSelectedListener} class which contains the necessary calls back
     * to the provided {@link ViewPager} so that the tab position is kept in sync.
     */
    public static class ViewPagerOnTabSelectedListener implements MaterialTabLayout.OnTabSelectedListener {
